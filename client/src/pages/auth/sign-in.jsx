...
export function SignIn() {
  ...
  const handleQuickLogin = async (role) => {
    setError("");
    const demoEmail = role === "admin" ? "admin@demo.com" : "author@demo.com";
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
              <div className="bg-indigo-50/50 dark:bg-indigo-950/20 border border-indigo-100 dark:border-indigo-900/50 rounded-xl p-4">
                <div className="flex items-center justify-center gap-2 mb-2">
                  ...
                  <Typography variant="small" className="font-bold text-indigo-950 dark:text-indigo-200">
                    Recruiter Quick Demo Access
                  </Typography>
                </div>
                <Typography variant="small" className="text-xs text-center text-indigo-700/80 dark:text-indigo-300/80 mb-3">
                  Click a button to sign in instantly with seeded demo accounts.
                </Typography>
                <div className="grid grid-cols-2 gap-3">
                  <button
                    type="button"
                    onClick={() => handleQuickLogin("admin")}
                    className="flex flex-col items-center justify-center p-3 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:border-indigo-500 dark:hover:border-indigo-400 hover:shadow-md hover:scale-[1.02] transition-all duration-200"
                  >
                    <span className="text-sm font-bold text-indigo-600 dark:text-indigo-400">Admin Demo</span>
                    <span className="text-[10px] text-gray-500 dark:text-gray-400 text-center mt-1">Manage Users & Reports</span>
                  </button>
                  <button
                    type="button"
                    ...
                    className="flex flex-col items-center justify-center p-3 rounded-xl bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 hover:border-indigo-500 dark:hover:border-indigo-400 hover:shadow-md hover:scale-[1.02] transition-all duration-200"
                  >
                    <span className="text-sm font-bold text-purple-600 dark:text-purple-400">Author Demo</span>
                    <span className="text-[10px] text-gray-500 dark:text-gray-400 text-center mt-1">Write Blogs & Explore</span>
                  </button>
                </div>
              </div>
            </div>
